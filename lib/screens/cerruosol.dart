    ...
    return Scaffold(
      ...
      Center(
        child: Column(children: [
          Text(citysList[2], style: const TextStyle(
  ...
  return FutureBuilder<WeatherModel>(
    ...
    builder: (context, snapshot) {
      ...
      // ),
        ...
        //     image: NetworkImage('https://upload.wikimedia.org/wikipedia/commons/2/24/ALASKA_%284477354433%29.jpg'),
        //     fit: BoxFit.cover,
        //   ),
        // ),
